$(function() {
  ...
  function addParticipants (data) {
    $('.'+data.username + ' .status').removeClass("away");
    $('.'+data.username + ' .status').removeClass("offline");
    $('.'+data.username + ' .status').addClass("online");
  }

  function removeparticipants(data) {
    $('.'+data.username + ' .status').removeClass("away");
    $('.'+data.username + ' .status').removeClass("online");
    $('.'+data.username + ' .status').addClass("offline");    
  }

  function awayParticipants(data) {
    $('.'+data.username + ' .status').removeClass("offline");
    $('.'+data.username + ' .status').removeClass("online");
    $('.'+data.username + ' .status').addClass("away");     
  }
